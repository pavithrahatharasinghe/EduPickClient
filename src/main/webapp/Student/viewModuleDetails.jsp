                        ...
                        <div class="container mt-5 flex-fill ml-2">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="card h-100" onclick="window.location.href='courseAssignments.jsp?ModuleID=<%=request.getParameter("ModuleID")%>&CourseID='+document.getElementById('courseId').value;" style="cursor:pointer;">
                                        <div class="card-body">
